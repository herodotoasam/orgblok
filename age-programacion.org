...
#+CAPTION: Clock summary at [2016-11-04 vie 13:31]
| Headline                                      |    Time |      |
|-----------------------------------------------+---------+------|
| *Total time*                                  | *14:22* |      |
|-----------------------------------------------+---------+------|
...
en Fechar.
*** TODO pestaña resumen de pedidos donde se pueda ver los pedidos
segun diversos criterios, todos, pendientes, entregados,
*** TODO posibilidad de pasar en algun lado el resultado de seven
