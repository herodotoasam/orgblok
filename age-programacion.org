...
#+CAPTION: Clock summary at [2016-11-03 jue 14:19]
| Headline                                     |    Time |      |
|----------------------------------------------+---------+------|
| *Total time*                                 | *12:24* |      |
|----------------------------------------------+---------+------|
...
| \emsp parte logica - guardado del pedido     |         | 0:32 |
| \emsp poner la linea check anulado/ causa... |         | 0:30 |
| \emsp nuevas ideas                           |         | 3:06 |
| tab seven                                    |    0:51 |      |
| tabVentas                                    |    0:41 |      |
| \emsp verificacion bug                       |         | 0:41 |
| Bug reaparece                                |    1:22 |      |
| \emsp tabFechar                              |         | 0:46 |
| \emsp reviso con pycharm lado a lado         |         | 0:36 |
#+END:
...
mejor.
** parte logica - guardado del pedido
...
** poner la linea check anulado/ causa anulamiento.
...
** nuevas ideas
*** que la busqueda dni, empalme a padron directo
y aparte esten las ya programadas de padron f/m/pf/pm
*** que haya un buffer de edicion de datos/ingreso de cliente nuevo
...
*** hacer un tipo packer-linea como tenia antes
...
*** guardar cliente nuevo editar cliente
...
*** mejorar el tabVer para que se pueda dirigir alli las vistas
