...
*** DONE varios pensados este finde
CLOSED: [2018-10-29 Mon 12:21]
...
**** DONE historial de Buscar
CLOSED: [2018-10-29 Mon 12:23]
...
*** DONE tablero de control promotores
CLOSED: [2018-10-29 Mon 12:23]
...
**** DONE info extra en Resumen
CLOSED: [2018-10-29 Mon 12:23]

***** DONE pedidos por promotor
CLOSED: [2018-10-29 Mon 12:23]
CLOCK: [2016-11-22 mar 21:46]--[2016-11-22 mar 21:48] =>  0:02
si es posible usando tree.

***** DONE pedidos por fecha
CLOSED: [2018-10-29 Mon 12:27]
...
*** DONE planilla de salida de mercaderia
CLOSED: [2018-10-29 Mon 12:27]
...
** DONE tablero informativo promotores 2018
CLOSED: [2018-10-29 Mon 12:27]
...
**** DONE boton de recalculado de tabla dinamica
CLOSED: [2018-10-29 Mon 12:27]
...
*** DONE Resumen por promotor con un listado de todos los datos y su resultado
...
*** DONE tabla de meses o campañas de promotores, comienzo y final y resultado
CLOSED: [2018-10-29 Mon 12:28]

para que se pueda hacer estadistica y reconstruir las planillas y los
pagos

** DONE mejorar pasado de cliente nuevo en pedido combobox y numero
CLOSED: [2018-10-29 Mon 12:28]
...
** DONE fichita de pedidos diferenciada y con leyenda
CLOSED: [2018-10-29 Mon 12:28]
...
** DONE [#A] Transformacion de pcods en datos usables por sqlite
- State "DONE"       from "TODO"       [2017-10-22 dom 12:36]
CLOCK: [2017-10-21 sáb 14:53]--[2017-10-21 sáb 16:53] =>  2:00
...
CLOCK: [2017-10-12 jue 20:05]--[2017-10-12 jue 20:53] =>  0:48
...
1. referencia a la fila del archivo que quedara como referencia futura
2. el comentario se hizo un ampersand para no perder ningun comentario
3. se copiaron a otra planilla los datos con un paste especial o sea
   sin formulas solo datos
4. se copio la columna de fechas aparte
5. se inserto una columna a la izquierda de id y se calculo en que id
   iba y se numero a partir del id real
6. se importo desde sqlite

*** DONE transformacion a cvs y lectura en sqlite
- State "DONE"       from "TODO"       [2017-10-21 sáb 16:55]
con el csv de campos id, fecha, cuenta importe y comentario me ubico
en sqlite3 y hago
.separator , 
.import datacsv.csv caja
y listo

*** DONE reparacion finita
CLOCK: [2017-10-22 dom 12:00]--[2017-10-22 dom 12:34] =>  0:34
- State "DONE"       from "TODO"       [2017-10-21 sáb 16:57]
un poco la hice volviendo a la planilla y luego vi que era mejor en
emacs pq me volvia loco. y emacs con el multoccur es mas rapido y
visible y ya trabajo sobre el archivo csv directamente.
HIce el agregado puesta al dia casi a mano de los ultimos asientos
pendientes de la caja que marca la planilla de caja que no estaba
pasada a pcodx y lo pase a la pc de libreoffice para saber su saldo y
lo pase a mano a emacs y lo updatee en la tabla de sqlite.
...
para adelante.
Falta una horita mas o menos en la transformacion mas dificil que es
el nombre de la cuenta y haciendolo a mano va volando, luego queda la
manipulacion en global para meterlo a la base de datos y hacer el programa.

** Insercion del sistema contable en el programa
*** pasado de asientos
CLOCK: [2017-10-14 sáb 15:05]--[2017-10-14 sáb 15:51] =>  0:46
CLOCK: [2017-10-14 sáb 14:30]--[2017-10-14 sáb 14:52] =>  0:22

**** DONE faltantes tbl borrado asiento
- State "DONE"       from "TODO"       [2017-10-15 dom 21:17]
CLOCK: [2017-10-15 dom 21:09]--[2017-10-15 dom 21:17] =>  0:08

**** TODO tbl coloracion rojo negativos
**** DONE total o sea saldo de caja
- State "DONE"       from "TODO"       [2017-10-15 dom 21:33]
CLOCK: [2017-10-15 dom 21:17]--[2017-10-15 dom 21:33] =>  0:16

*** posible hoja mayorizadora o visualzadora de una cuenta por vez pe. retiros
CLOCK: [2017-10-22 dom 12:36]--[2017-10-22 dom 13:08] =>  0:32
CLOCK: [2017-10-21 sáb 23:15]--[2017-10-21 sáb 23:36] =>  0:21
claro que una vez que tenga todos los datos adentro sera facil
trabajar con ellos.
Le puse una visualizacion por fecha de distintos colores y esta
bueno. Ahora para mayor facilidad de movimiento faltaria un scroll
vertical. veo si lo puedo incorporar en unos pocos minutos.
Renegue un poco pq no podia packear los scroll, hice un scrollhorver
que pone los dos scroll. 
Revisando los scroll en el resto del programa vi casos obsoletos en
los cuales se habia hecho a mano el packeo del scroll y quise
aplicarlo automaticamente y no funciona y se desacomoda la visualidad,
la cual no esta muy definida pq no se sabe bien para que tama:o de
pantalla optimizar si no se con que pantalla trabajo, notebook,
netbook, la pantalla 22 o la pantalla de la cami.

*** DONE paso automatico de planillas de caja
- State "DONE"       from "TODO"       [2017-10-22 dom 15:34]
CLOCK: [2017-10-22 dom 14:49]--[2017-10-22 dom 15:15] =>  0:26
listo ya lo hice por el momento les pongo a todos la misma cuenta
cobranza para mantener la uniformidad con lo que venia haciendo o sea
tener el neto de la cobranza y a partir de cierto momento tendria que
empezar a discrimar con las tres cuentas lo cual seria facil a nivel
programa hacer tres lineas de codigo.

** TODO Sistema de control y de contabilizacion de promocion

usar un sistema de control de jornales que de paso sirva para desde el
punto de vista contable tener los asientos de cospeles, vales y pagos
a promotores que son los tres tipos de erogaciones que conlleva un
promotor.
Una simple tablita jornales (que creo que ya existe con fecha, idvdor,
cospel, pagos), y otra tabla anexa tendria que haber que limitara los
periodos o sea que tuviera los limites de las planillas como la que
llevo en la planilla excel o sea prom, fechacomienzo/ fechafinal, y
luego el sistema que calcule lo que pague de viatico, comisiones, y
ventas en el medio. Podria empezar con los actuales y que en el
momento que se vuelva operativa que empiece a volcar datos a la caja,
antes lo meto a mano, y luego armo todas las planillas anteriores del
sistema con lo que tengo en emacs y luego lo importo en sqlite por
orden.

* IDEA cambiar estructura de tabFechar

pienso en una estructura hecha con entrys en el cual pueda poner la
fecha con fecha2 en forma de numero mas facilmente.
Quizas teniendo un calendario a la vista en el mismo formulario.
quizas agregando a fecha2 facilidades como dias de la semana o pl o pm
para proximo lunes o pmomartes
y unos botones que llevaran a hacer las cosas que eventualmente se
hacen en edicion como edicion de direccion o comentario, o demas
cosas.
Pq en realidad esa es una tabla que se maneja con raton y tendria que
manejarse con teclado para ser mas rapida.

Hay una cosa que es un lack. Que cuando se programo eso, era pq se
necesitaba y tabVer no tenia capacidad de edicion, e incluso no la
tiene hoy en dia, o sea no puedo editar en las pestañas internas
aclaracion/mensaje/comentarios/horarios en tabver y me tengo que ir a
fechar.
Primero habria que corregir eso. Para dejar un fechador mas eficiente.

* IDEA poner el historial del cliente en otra tabla
* reparaciones generales
** tema database locked a causa de tareas iniciales
CLOCK: [2018-01-30 mar 20:05]--[2018-01-30 mar 20:15] =>  0:10
CLOCK: [2018-01-30 mar 19:48]--[2018-01-30 mar 20:03] =>  0:15
parece que es por un campo mes/year en tabla ventas
agregado por trigger no hace falta una actualizacion que me lockeo la
base de dato al menos aca.

** arreglos de confusiones en el pasado de ventas
CLOCK: [2018-01-30 mar 20:15]--[2018-01-30 mar 20:31] =>  0:16
saque el boton PASAR total que es la desactivacion de bdirecto #4548
saque la fechaprocesando en #4431 y aledañas.
O sea que se puede volver a activar
Pero era confuso para mi, pues un par de veces active dos veces una
venta quedando una venta fantasma y vacia, y no quiero que la cami se
equivoque. que pase todo por items. y el tema fecha que ponga todo por
fecha, los excesivos automatismos no hacen falta para los demas y
pueden crear errores.

* ideas de auditoria
** pasado de recibos

agregar al exterior de la planilla el monto total y revisar el toco
del dia en la planilla resumen para ver si fue pasado a planilla de
caja, o sea de paso que reviso si la cantidad global fue bien pasada
veo si fue pasado a caja (detecte varios errores en los que revise)

** planilla de gastos de Fede sera mensual ahora

eso sera mucho mas facil de gestionar y de pasar y de controlar

** revisar las nuevas ventas ingresadas
...
* idea de control de stock
** idea basica

tabla compras(id fecha art(reference art) cnt costo proveedor) 
o sea simplifico en una sola tabla lo que seria compra y detalle de
compra  pq en la practica no llevamos un registro de las compras como
unidad administrativa en si que debamos referenciar (pe num de factura
o num de remito o costo de flete) son informaciones contables quizas
deseables estadisticamente pero que en la practica se nos hace muy
dificil pasar, entonces la simplificacion viene por el lado de obviar
ese paso o bien dejarlo pero repetitivo p.e. num de factura.
La diferencia con el sistema anterior es que se calcularia el stock
como una suma o bien resta entre compras (entrada de mercaderia) menos
ventas (salidas de mercaderia) y no a traves de triggers. 
El stock inicial seria como compra cero, y las ventas de contado se
cursarian como ventas de contado normales en la base de datos. Idem
todo otro tipo de ventas. Todo otro tipo de caso de salida por falla
etc, se pasa como compra negativa. 
