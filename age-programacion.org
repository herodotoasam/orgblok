...
#+CAPTION: Clock summary at [2016-11-22 mar 22:13]
| Headline                                       |       Time |       |
|------------------------------------------------+------------+-------|
| *Total time*                                   | *1d 15:59* |       |
|------------------------------------------------+------------+-------|
...
| tabCobrado                                     |       1:51 |       |
| \emsp pivot por cobrar                         |            |  1:18 |
| \emsp generalizar la disposicion para poner... |            |  0:13 |
| \emsp agregar a tabla virtual cuotas status... |            |  0:20 |
#+END:
...
*** TODO pasado directo del pedido como venta
...
**** Podriamos poner un campo extra en pedido: idvta
