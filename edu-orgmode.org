...
agrega una columna en la posicion actual
***** Atajo                                                       :drill:
:PROPERTIES:
:DRILL_CARD_TYPE:
:END:
...
M-S-down
****** borra la columna actual
agrega una fila en la posicion actual
** TODO Avanzado                                                      :anki:
SCHEDULED: <2017-02-08 mié +60d>
- State "DONE"       from "TODO"       [2016-12-16 vie 20:46]
- State "DONE"       from "TODO"       [2016-11-11 vie 21:22]
- State "DONE"       from "TODO"       [2016-11-01 mar 20:44]
:PROPERTIES:
:LAST_REPEAT: [2016-12-16 vie 20:46]
:END:
*** sumar
