...
desde mes 
** pegar el nombre
** ver poblacion objetivo para llamar (llamables)
** incluso se podria separar con botones los cancelados los no llamables
** facilidad para editar mjecobr y otros campos de informacion
** tendria que haber un campo wassapeado para que se sepa los que ya estan contactados
** tendria que haber un campo cerrado ya sea pq respondio positivo o negativo o pq no anda el tel
