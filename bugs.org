...
#+COLUMNS %TODO%TAGS
* TODO bugs o improvs fichaje.py [36/59]
...
** TODO ventas pasadas agregar campo comprado y suma a comprado y cuotas :tabPasarVentas:
...
internamente.   
** TODO hacer funcion promediar                                  :Generales:
** TODO estadisticas ventas sume articulos                 :tabEstadisticas:
** TODO funcion totalizar de tbls que sume valores negativos     :Generales:
** TODO hacer que se recalcule el saldo de caja de alguna forma :tabCaja:
