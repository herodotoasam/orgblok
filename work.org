...
** TODO gestion de emails
+ [ ] buscar un gestor de email en linux que centralice todos las
  cuentas y sea eficiente.
+ [ ] cargar todas las cuentas en fair-mail en el celular
+ [ ] buscar nuevas cuentas que funcionen en ambos sistemas para ir
  reemplazando gmail
...
1. stock.py
** TODO transformar Vue en alpinejs [75%]
