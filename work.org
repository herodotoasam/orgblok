...
Voy a ver de poner el auto-save con gatito pero no funciona por ahora.
No entiendo, pero bueno lo vamos a poner en vista. Puede ser mal
puesto el valor de la variable. No encuentro. Ya funciona bien.
** revert buffers
[2022-11-23 Wed]
...
** move files con dired
[2022-11-24 Thu]no es algo facil.
Me quedo colgado un denote en otro directorio y tenia que moverlo a
orgblok/, y lo marco, aprieto R y todo bien, solo que al poner el
directorio me impide hacer autocomplete con el nombre del file que es
largo y complejo.
Tenia que poner R y tratar de cambiar el dir sin que se me fuera de
foco, -lo cual paso dos veces-, y se hizo el cambio.
Baje una funcion que bindie a Cx-Cm que mueve un buffer y su file a
otro directorio pero tiene el mismo problema no hay complete en el
nuevo directorio. Es lo mismo. Aunque ya no creo que sea parte del
problema diario pq volvi a setear que los denotes se hagan dentro de org.
...
*** DONE agregar garante a pasado de ventas
CLOSED: [2022-11-25 Fri 18:19]
solo queda pendiente el tema update de las garantias ya en curso pero
hay que ponerlas correctamente en la venta correspondiente, o sea hay
que hacerlo con la venta en la mano.
...
+ [X] error al pasado de numero de cobrador
  [2022-11-22 Tue]
+ [X] error al pasado de plan de pago
  [2022-11-23 Wed]
  ...
  Al final lo que hice fue una funcion en python que verifica si un
  idvta es una cuenta muerta con la condicion de que es un ppago o sea
  pp=1 y no tiene pagos asociados. Entonces la borro. Y luego genero
  el plan de pagos. O sea que se puede generar un plan de pagos arriba
  de uno erroneo sin problema pq el de abajo se borrara.
+ [X] visor de tabla planes de pago
  no hay tabla de planes de pago. Cuando se genera un plan de pago se
  marca pp=1 la venta, pcondo=1 las otras ventas y no se hacen los
  logs no hay una tabla aparte.
...
+ [ ] nueva tabla para poner recibos-por-transferencia el numero de
  asiento
  pienso que seria muy engorroso y un trabajo extra para mi llevar esa
  tabla mejor seria un calculo cruzado
  asiento-bancos-ingresos-clientes con pagos-
  Corriendo unas consultas da bien. Tendria que ver como hago el tema
  si con un test seco, o una tabla o algo mas elaborado. Lo dejo pendiente.
...
+ [X] hacer validacion en cargar loterecibos para evitar errores por lo
  menos en idcobr.
  Doble validacion, indica que el cobrador no existe y si lo ignoras
  no te deja procesar el lote.
+ [X] visor de planes de pago: usando una consulta y diferentes vistas.
  podria ser un boton fichaje para no generar paginas al vicio y
  aprovechar infraestructura. Se hicieron los cambios en la base de
  dato.
+ [X] estimados a cobrar tiene el eje x erroneo no es num de cobradores
  es mes
+ [X] poner entrada en menu especial auditoria para user hfj024 o hfj050
  ej log y los otros que genere. Para no pulular el sistema.
+ [ ] borrar codigo comentado en todos los templates cuando borramos el
  botonaje.
+ [X] gestion garantes: poner un listado en Fichas, de garantizados.
  fijarse como seria el flujo de trabajo con los vinculos a garante y
  esas cosas. En fichas tenes la lista, vas al link, luego apretas el
  tag garante y abris el garante y le mandas el boton programado de
  intimacion al garante. No puedo hacer un msg automatico pq un
  garante puede garantizar mas de un deudor. Para eso tendria que
  tener una consulta que me mostrara sus garantizados y listara los
  whatsapp de reclamo garantia de deudores. Tambien podria haber un
  tag azul, ES GARANTE y un tbls abajo con los garantes y la situacion
  de los garantes. para ver si podemos decidir venta.
+ [X] poner un tag en fichas que indique en que cuadro estamos.

* agenda de actividad
[[denote:20221129T094020][objetivos...]]
** semana [2022-11-27 Sun]
*** [2022-11-30 Wed]
:LOGBOOK:
CLOCK: [2022-11-30 Wed 18:03]--[2022-11-30 Wed 20:00] =>  1:57
ultimo round del dia. Seguiremos mañana.
CLOCK: [2022-11-30 Wed 14:25]--[2022-11-30 Wed 15:36] =>  1:11
seguimos pero esta dificil
CLOCK: [2022-11-30 Wed 11:10]--[2022-11-30 Wed 12:05] =>  0:55
atascado por un error pero avanzando.
CLOCK: [2022-11-30 Wed 09:20]--[2022-11-30 Wed 10:52] =>  1:32
segunda aproximacion vamos mejorando ya tenemos tabla users
CLOCK: [2022-11-30 Wed 07:24]--[2022-11-30 Wed 09:04] =>  1:40
primera aproximacion fallida a crear la tabla users nueva
:END:
*** [2022-11-29 Tue]
:LOGBOOK:
CLOCK: [2022-11-29 Tue 18:35]--[2022-11-29 Tue 20:10] =>  1:35
lectura de seguridad en red y flask-praetorian
CLOCK: [2022-11-29 Tue 18:10]--[2022-11-29 Tue 18:35] =>  0:25
reacomodado de pc y modem
CLOCK: [2022-11-29 Tue 17:09]--[2022-11-29 Tue 18:09] =>  1:00
armado de sillon aero-cool
CLOCK: [2022-11-29 Tue 15:21]--[2022-11-29 Tue 16:50] =>  1:29
penetration test against flask - bastante bien.
CLOCK: [2022-11-29 Tue 11:23]--[2022-11-29 Tue 12:20] =>  0:57
pruebas sobre logging.warning
CLOCK: [2022-11-29 Tue 06:23]--[2022-11-29 Tue 07:45] =>  1:22
lectura preliminar de flask-autentication.
:END:
*** [2022-11-28 Mon]
:LOGBOOK:
CLOCK: [2022-11-28 Mon 16:55]--[2022-11-28 Mon 17:36] =>  0:41
corrigiendo git-mirror
CLOCK: [2022-11-28 Mon 15:46]--[2022-11-28 Mon 16:52] =>  1:06
asientos agrego validacion de control y otras validaciones.
CLOCK: [2022-11-28 Mon 10:10]--[2022-11-28 Mon 12:45] =>  2:35
garantias: mucho trabajo con los triggers
CLOCK: [2022-11-28 Mon 07:53]--[2022-11-28 Mon 10:02] =>  2:09
garantias: renegue mucho con la base de datos
CLOCK: [2022-11-28 Mon 07:17]--[2022-11-28 Mon 07:45] =>  0:28
emacs: instalo folding ts
:END:
*** [2022-11-27 Sun]
:LOGBOOK:
CLOCK: [2022-11-27 Sun 20:00]--[2022-11-27 Sun 20:40] =>  0:40
github-bitbucket reemplazo de clave
CLOCK: [2022-11-27 Sun 15:50]--[2022-11-27 Sun 17:12] =>  1:22
github-bitbucket haciendo el sistema orgblok
CLOCK: [2022-11-27 Sun 12:25]--[2022-11-27 Sun 12:49] =>  0:24
github multiples cuentas si pude hacerlo.
CLOCK: [2022-11-27 Sun 09:00]--[2022-11-27 Sun 10:00] =>  1:00
pasado de los garantes
CLOCK: [2022-11-27 Sun 07:30]--[2022-11-27 Sun 08:58] =>  1:28
tiempo perdido para hacer una segunda cuenta de github.
CLOCK: [2022-11-27 Sun 07:05]--[2022-11-27 Sun 07:16] =>  0:11
inicio
:END:
** semana [2022-11-20 Sun]
*** [2022-11-26 Sat]
:LOGBOOK:
CLOCK: [2022-11-26 Sat 18:46]--[2022-11-26 Sat 19:12] =>  0:26
cambie las claves de mis usuarios. Deje un usuario comun.
...
CLOCK: [2022-11-26 Sat 07:28]--[2022-11-26 Sat 07:47] =>  0:19
hice alias para mirror global
CLOCK: [2022-11-26 Sat 06:47]--[2022-11-26 Sat 07:28] =>  0:41
quise separar fl5 a github romitex pero no pude.
:END:
*** [2022-11-25 Fri]
:LOGBOOK:
CLOCK: [2022-11-25 Fri 19:10]--[2022-11-25 Fri 19:29] =>  0:19
agregue Auditoria
CLOCK: [2022-11-25 Fri 18:25]--[2022-11-25 Fri 19:10] =>  0:45
data mining: zonas
CLOCK: [2022-11-25 Fri 16:00]--[2022-11-25 Fri 16:46] =>  0:46
seteando password en vivaldi y sitios alternativos en github/lab
CLOCK: [2022-11-25 Fri 10:52]--[2022-11-25 Fri 12:20] =>  1:28
casi termino el tema garantia
CLOCK: [2022-11-25 Fri 09:39]--[2022-11-25 Fri 10:38] =>  0:59
CLOCK: [2022-11-25 Fri 08:35]--[2022-11-25 Fri 08:55] =>  0:20
defino los alcances del tema garante a pasado de ventas
CLOCK: [2022-11-25 Fri 07:12]--[2022-11-25 Fri 07:38] =>  0:26
inicio del dia
:END:
*** [2022-11-24 Thu]
:LOGBOOK:
...
elisp: estudio
CLOCK: [2022-11-24 Thu 13:35]--[2022-11-24 Thu 13:48] =>  0:13
corrijo bug cuadro estimados
CLOCK: [2022-11-24 Thu 12:00]--[2022-11-24 Thu 12:10] =>  0:10
preliminar de revision asiento-pago-transferencias
CLOCK: [2022-11-24 Thu 11:00]--[2022-11-24 Thu 11:22] =>  0:22
validacion de cobr en loterbo
CLOCK: [2022-11-24 Thu 08:56]--[2022-11-24 Thu 10:25] =>  1:29
muestro lista de planes de pagos en Fichas
CLOCK: [2022-11-24 Thu 07:47]--[2022-11-24 Thu 08:35] =>  0:48
corrijo bug de ventas saldo<0 no se mostraban.
CLOCK: [2022-11-24 Thu 06:51]--[2022-11-24 Thu 07:14] =>  0:23
usando mail unificado de vivaldi un espectaculo.
:END:
*** [2022-11-23 Wed]
:LOGBOOK:
...
CLOCK: [2022-11-23 Wed 17:30]--[2022-11-23 Wed 18:37] =>  1:07
planes de pago elimina planes muertos
CLOCK: [2022-11-23 Wed 16:55]--[2022-11-23 Wed 17:30] =>  0:35
emacs auto-save
CLOCK: [2022-11-23 Wed 13:00]--[2022-11-23 Wed 14:30] =>  1:30
hice un fk y otras cosas.
...
:LOGBOOK:
- Rescheduled from "[2022-11-28 Mon]" on [2022-11-28 Mon 17:36]
...
**** backup
SCHEDULED: <2022-11-29 Tue .+3d>
:PROPERTIES:
:LAST_REPEAT: [2022-11-26 Sat 07:40]
:END:
:LOGBOOK:
- State "DONE"       from ""           [2022-11-26 Sat 07:40]
- State "DONE"       from ""           [2022-11-23 Wed 20:17]
...
:LOGBOOK:
- Rescheduled from "[2022-11-25 Fri]" on [2022-11-26 Sat 07:40]
:END:
**** recargar uala para whatsapp-api
SCHEDULED: <2022-12-05 Mon>
