...
** al cambiar theme hay problemas
...
** BUG  luego de un sort y refresh sigue quedando el ultimo icon
tiene que haber una forma de limpiar.

** BUG [#A] cuando se hace una suma y no se borra luego se busca otro cliente la
suma queda
