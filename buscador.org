...
** corregir
*** vdor poner vdor default
*** corregir la impresion que imprime todo el barrio y no lo seleccionado
** hacer
*** pasar vdor a clientes y fecha de impresion
*** trigger para tablalog 
*** opcion de borrar la impresion
*** tbls para ver las zonas impresas
*** tbls para ver las ventas mensuales por zona 
