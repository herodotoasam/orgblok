...
** Recibos
*** Desisto de la idea de Recorrido y sus procesos
...
*** No tantas facilidades para entrar el numero de cuenta y recibo
...
*** Separo el proceso de control de planillas al de caja
...
*** Faltaria la emision de Lotes desde aca 
    esto completaria la funcionalidad del programa sin la parte tablero de 
    control.
...
**** el bind n que cambia de row a cell no vuelve a row
