...
#+CAPTION: Clock summary at [2020-08-05 Wed 19:47], for August 2020.
| Headline               |    Time |
|------------------------+---------|
| *Total time*           | *22:20* |
|------------------------+---------|
...
**** TODO tener en cuenta que pmvto no es una funcion
**** TODO actualizaciones de pagos
...
**** TODO BUG: los pagos no alteran el saldo o no activan el trigger
la cuota sigue apareciendo 
**** TODO BUG: ver cta 76917 muestra cuotas a cobrar viejas
**** TODO no existen los triggers pagos
...
**** TODO [#A] proc actualiza_datos_clientes
**** TODO [#A] sacar gc y poner generarcuotas
*** TODO fichas.tcl
*** TODO stock.tcl
