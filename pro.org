...
#+CAPTION: Clock summary at [2020-07-29 Wed 16:42], for July 2020.
| Headline               |      Time |
|------------------------+-----------|
| *Total time*           | *7d 1:24* |
|------------------------+-----------|
| Agenda Romitex         |     23:31 |
...
| Agenda de estudio      |   6d 1:53 |
| \_  2020-Julio         |   6d 1:53 |
...
** semana [2020-07-26 Sun]                                         :Itcl:TCL:
...
**** innovaciones
***** buscador abajo general para casos que no este bien el dni
***** clientes en la direccion mientras estoy pasando incluido el mismo
**** TODO sacar btn generarvta y num vta del recuadro
...
apertura y cierre
**** TODO bug vdores aparecen entre llaves 
*** unknown.tcl
