...
#+CAPTION: Clock summary at [2020-07-31 Fri 13:00], for July 2020.
| Headline               |       Time |
|------------------------+------------|
| *Total time*           | *7d 12:50* |
|------------------------+------------|
| Agenda Romitex         |    1d 0:14 |
...
| Agenda de estudio      |   6d 12:36 |
| \_  2020-Julio         |   6d 12:36 |
...
C-o C-i
** evil-mode con emacs
    tendria que ser lo mejor de los dos mundos
    entra en modo de edicion con la o-a-a-s
    o sea las usuales de vim. 
    hasta donde puedo ver se pueden usar los comandos de emacs tambien.
    bastante bueno. Habria que ver si se comporta igual de rapido que vim
    es un poco mas lento en apariencia, pero suma toda la capa de
    emacs. Eso hay que tenerlo en cuenta, quizas no es para abrir y cerrar
    a cada rato, pq tiene varios buffers abiertos, aparte el reloj de org
    requiere que el programa no se cierre, pero la navegacion es
    totalmente rapida y los comandos iconicos de vim estan presentes. Lo
    unico que le faltaria seria una powerline que tuviera en cuenta el
    evil-mode y me indicara en forma mas grafica el modo, normal, insert,
    visual con colores distintos.
...
**** TODO bug listbutton no configure -state disabled
...
**** TODO tab y sistema de proc control ventas
     ...
     en el pago.
**** TODO tab de estadisticas con graficos
...
*** TODO refactorizado buscapg.tcl
