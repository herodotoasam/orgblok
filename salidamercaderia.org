#+TODO: TODO(t) BUG IDEA IMPROV | DONE(d!) FIXED
* Monica
...
* TODO bugs o improvs fichaje.py [0/27]

** TODO sacar la traba en dni de pedidos                        :tabPedidos:
...
** IDEA que los tbls tengan un bind que te diga el nombre intenro del tbls :tablelist:
...
** BUG chequear pq cuando paso elva cada vez dice ballon listado generado lo cual es molesto :tabPasarRecibos:
y no se pq se genera de nuevo un listado alli.
** BUG verificar el funcionamiento del boton purgar        :tabPasarRecibos:
