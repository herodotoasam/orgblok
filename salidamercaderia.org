...
* TODO bugs o improvs fichaje.py [1/29]
...
** BUG el tbl moradito de planillas es un desastre id ordena mal, no tiene colspesos no recalcula etc :tabPasarRecibos:
** BUG en tbl loterbos la cnt la llena mal pq a todos pone 50 :tabPasarRecibos:
* Preguntar Fede
** DONE pedir queen!!
