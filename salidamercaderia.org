...
* TODO bugs o improvs fichaje.py [22/39]
...
** IDEA que los cancelados en Fechar coloreen orange para no fijar vista :tabFechar:
** IDEA hacer sistema de guardar exdirecciones
...
** TODO ver si en tbls pedidos los E/A/Z pueden ser e/a/z y el rojo puede tener fg='white' :tabPedidos:
* Preguntar Fede
** DONE pedir queen!!
