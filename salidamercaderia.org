...
* TODO bugs o improvs fichaje.py [6/36]
...
o rbo o dni
** TODO [#C] sacar los balloons de listado cargado y recorrido cargado :tabPasarRecibos:
...
** BUG recibos repetidos                                   :tabPasarRecibos:
