...
** TODO en planillas de lotes que el tree llene con los usados coloreados y nominados
para tener conciencia del uso
** TODO poner en planilla de lotes una columna con la cnt de rbos que tiene el lote.
** TODO URG poner boton en TabVer evaluar direccion.
** IDEA un subtab en Ventas con las fichas para imprimir de Mon y Elva 
** BUG los botones guardarventas e item deben parar!!!
