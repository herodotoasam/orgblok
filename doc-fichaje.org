...
**** acceso directo a modificadores de calle,num,zona
     ...
     :PROPERTIES:
     :ID:       777bcaf8-a605-4ed2-8434-8cca0ebaf420
     :END:
...
** Modulo documentos
   ...
   :PROPERTIES:
   :ID:       e0777e3b-d195-4107-9b87-cba8c0f4cd12
   :END:
...
*** registro de intimaciones 
    ...
    :PROPERTIES:
    :ID:       6c6df526-63b1-416e-b08c-15d2b438c9a7
    :END:
...
*** Ubicacion de cuenta en tbs cuentas con raton
    ...
    :PROPERTIES:
    :ID:       e04c89fd-d126-4f04-8865-a304ddf7baa0
    :END:
...
** TODO [#A] Proceso de Intimaciones
   :PROPERTIES:
   :ID:       8dcc4553-6399-4b25-9160-c91d4064e5a5
   :END:
** TODO Proceso de documentos
   :PROPERTIES:
   :ID:       19bc9deb-e63b-46bf-98ee-995a2c8c2c4c
   :END:
...
** TODO Registro en tabla aparte de las intimaciones emitidas
   ...
   ese campo. 
** Confirmacion o borrado de la intimacion en el momento de fechar
...
entregada.
** Carga automatica? del cobr que entrego la intimacion en el momento de fechar
...
** Como se sale del estado intimar
...
** debe mostrarse en el resumen las intimaciones impresas para guia
** debe mostrarse en la planilla las intimaciones impresas?
...
es que lea en la tabla intimaciones con fecha de hoy)
** como y cuando decido que tipo de intimacion imprimir y como se carga eso
...
momento de imprimir que se debe hacer a mil sin mayores complicaciones.
** aparte podria haber un tbls general con log de intimaciones y pivot varios
   todo un tema estadistico posterior al proceso que permita evaluar los
   resultados de las intimaciones.
** una forma de intimar por lote sin marcado previo para Elva y Monica
** Forma de incluir dentro de las intimaciones info dinamica sobre estar ya en seven
** Deberia haber un tipo de intimacion? que se determinara al marcar
...
** Deberia la intimacion tener un plan de pagos? como era antes?.
