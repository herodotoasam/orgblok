...
** Como marcar el documento pedido (teniendo en cta que es idvta)
...
** un tab o subtab de documentos pedidos con facilidad para borrar o des-pedir
...
** donde residiria el pedido y el control
*** en tabla ventas
